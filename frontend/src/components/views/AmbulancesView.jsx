...
import { useBusyUnits } from '../../hooks/useAmbulanceStore';

const FLEET = [
  { id: 'A-12', name: 'Ravi Kumar',    number: 'AP09 AB 1234' },
  { id: 'A-08', name: 'Suresh Reddy',  number: 'TS10 CD 5678' },
  { id: 'A-23', name: 'Arjun Sharma',  number: 'KA01 EF 9012' },
  { id: 'A-47', name: 'Imran Khan',    number: 'MH12 GH 3456' },
  { id: 'A-31', name: 'Vikram Singh',  number: 'DL05 JK 7890' },
  { id: 'A-55', name: 'Rahul Verma',   number: 'AP28 LM 4321' },
  { id: 'A-62', name: 'Manoj Yadav',   number: 'UP32 QR 8765' },
  { id: 'A-77', name: 'Kiran Patel',   number: 'GJ01 ST 1122' },
];

const FUEL = [95, 72, 88, 61, 79, 54, 90, 67];

export default function AmbulancesView() {
  const busyUnits = useBusyUnits();
    ...
    <div className="view-container">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '1.5rem' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.82rem', fontFamily: 'monospace', marginTop: 2 }}>
            {FLEET.length - busyUnits.size} available · {busyUnits.size} deployed
          </p>
        </div>
      ...
      <div className="grid-responsive">
        {FLEET.map((unit, index) => {
          const isBusy = busyUnits.has(unit.id);
          const fuel = FUEL[index];
